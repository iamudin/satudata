...
<section id="icon-boxes" class="icon-boxes">
  <div class="container">
    ...
    <div class="row justify-content-around">
      ...
      <div class="col-md-4 col-lg-2 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
        <div class="icon-box">
          <center><div class="icon"><img src="{{asset('link/e-walidata.png')}}" width="100" height="100"></div></center>
          <center><h4 class="title" style="font-size: 10pt;"><a href="https://sipd.go.id/ewalidata/1f5a8d42f62a26999e2b97f4bd0eb7bc1ad2e94b/?m=public_dssd_tabel" target="_blank">E-WALIDATA</a></h4></center>
          <center><p class="description">Publikasi Data Statistik Sektoral</p></center>
        </div>
      </div>
